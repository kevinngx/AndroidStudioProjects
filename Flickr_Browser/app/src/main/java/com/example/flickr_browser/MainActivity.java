...
public class MainActivity extends BaseActivity implements GetFlickrJsonData.OnDataAvailable,
    ...
    protected void onResume() {
        ...
        GetFlickrJsonData getFlickrJsonData = new GetFlickrJsonData(this,"https://api.flickr.com/services/feeds/photos_public.gne", "en_us", true );
        getFlickrJsonData.executeOnSameThread("hentai");
        super.onResume();
    ...
    public void onItemLongClick(View view, int position) {
        ...
        // Object needs to be serializeable
